        ...
        <div class="stocksSingle__wrap">
            ...
            <div class="stocksSingle__wrap-right">
                ...
                <div class="stocksSingle__infoBox">
                    ...
                    ?>
                    <div class="stocksSingle__views stocksSingle__infotext"><img src="http://viatka1c.loc/wp-content/themes/viatka1s/frontend/dev/assets//images/icons/views1.svg" alt="views"><span>Просмотров:</span><?= get_field('promo-views') ?></div>
                    <div class="stocksSingle__share stocksSingle__infotext"><div class="stocksSingle__shareImg"><img src="http://viatka1c.loc/wp-content/themes/viatka1s/frontend/dev/assets//images/icons/share.svg" alt="share"></div><a href="#">Поделиться</a></div>
                </div>
            </div>
