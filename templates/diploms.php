<?php
$diplomsRep = get_field('diploms-rep', 'options');
?>
<section class="diploms">
    <div class="container">
        <h2 class="title diploms__title"><?= get_field('diploms-title', 'options') ?></h2>
        <div class="diploms__wrapper">
            <div class="swiper">
                <div class="swiper-wrapper" data-lightbox-parent>
                    <?php foreach ($diplomsRep as $key => $item): ?>
                        <a class="diploms__link" href="<?= $item['diploms-img'] ?>" class="slider__item" data-fancybox="slider">
                            <img class="diploms__img" src="<?= $item['diploms-img'] ?>" alt="diplom">
                        </a>
                    <?php endforeach; ?>
                </div>
