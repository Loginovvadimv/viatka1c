...
<!--                <p class="fs16">--><?php //= get_field('become-partner', 'options') ?><!--</p>-->
<!--            </div>-->
...
<!--                            <li class="becomePartnerpage__li fs16">--><?php //= $partner['list-partners'] ?><!--</li>-->
<!--                        --><?php //endforeach; ?>
<!--                    </ul>-->
<!---->
<!--                </div>-->
...
<!--                            <li class="becomePartnerpage__li fs16">--><?php //= $destr['destr-list'] ?><!--</li>-->
<!--                        --><?php //endforeach; ?>
<!--                    </ul>-->
<!---->
<!--                </div>-->
...
<!--                </div>-->
<!--                <img class="becomePartnerpage__img" src="--><?php //= ASSETS ?><!--/images/partners.webp" alt="partner" loading="lazy">-->
<!--                <button class="becomePartnerpage__btn btn-orange" data-modal="partners">Оставить заявку</button>-->
<!--            </div>-->

            <?php get_field(the_content()) ?>
        </div>
    </div>
</section>
